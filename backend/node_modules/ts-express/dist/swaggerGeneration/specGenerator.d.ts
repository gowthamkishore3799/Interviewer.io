...
export declare class SpecGenerator {
    ...
    GenerateSpec(swaggerDir: string): Swagger.Spec;
    GetSpec(): Swagger.Spec;
    private buildDefinitions();
    private buildJwtSecurityDefinition();
    private buildPaths();
    private buildPathMethod(method, pathObject, jwtUserProperty, tag);
    private buildParameter(parameter);
    private buildProperties(properties);
    private buildOperation(method);
    private getSwaggerType(type);
    private getSwaggerTypeForPrimitiveType(primitiveTypeName);
